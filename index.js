...
export class GPUComputationRenderer {
  ...
  createRenderTarget(sizeXTexture = this.sizeX, sizeYTexture = this.sizeY, wrapS = THREE.ClampToEdgeWrapping, wrapT = THREE.ClampToEdgeWrapping, minFilter = THREE.NearestFilter, magFilter = THREE.NearestFilter) {
